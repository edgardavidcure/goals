...
function OfferCard({ icon, header, subHeader }: OfferCardProps) {
  return (
    <div className="flex flex-col flex-1 h-52 min-w-44 items-start justify-start px-5 py-8 shadow-lg bg-white rounded-lg ">
      ...
      <h5 className="my-2 text-start text-lg font-bold tracking-tighter md:text-2xl lg:text-2xl/none">
        {header}
      </h5>
...
export default function Section() {
  return (
    <section className="px-10 bg-extra-light-orange py-12">
      ...
      <p>
        Our Platform offers a variety of features to help you track and achieve
        your goals.
      </p>
      <div className="flex w-full gap-8 items-center justify-evenly flex-wrap my-10">
        <OfferCard
          ...
          subHeader="Track your progress towards your goals."
        />
        <OfferCard
          icon={shareIcon}
          header="Goal Sharing"
          subHeader="Share your goals with others."
        />
        <OfferCard
          icon={scheduleIcon}
          header="Scheduling"
          subHeader="Schedule tasks and reminders to keep you on track."
        />
      </div>
    </section>
  );
