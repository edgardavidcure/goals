...
function AuthButton({ session }: AuthButtonProps) {
	if (session) {
	  ...
	  return (
		<>
		  <button className="text-black w-fit flex bg-extra-light-orange p-2 rounded-lg hover:bg-opacity-50 hover:text-white" onClick={() => signIn()}>Sign In</button>
		</>
	  );
	}
  }
...
function DashboardButton(){
	return (
		<a href="/profile" className=" text-black  bg-extra-light-orange p-2 rounded-lg  hover:bg-opacity-80">Dashboard</a>
	)
}
