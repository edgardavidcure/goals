          ...
          <div className="flex relative bg-extra-light-orange w-full py-6 px-6 rounded-xl">
            <div className="flex gap-2 absolute right-0 top-6 me-4 md:me-6">
              <button
                ...
                className="w-9 p-2 rounded-lg md:w-10 hover:bg-light-orange"
              >
                <PencilIcon />
              </button>
              <button
                ...
                className="w-9 p-2 rounded-lg md:w-10 hover:bg-red hover:text-white"
              >
                <TrashIcon />
              </button>
            </div>
                ...
                <div className="bg-white p-6 rounded-lg">
                  ...
                  <div className="flex justify-end mt-4">
                    <button
                      ...
                      className="mr-2 bg-red text-white px-4 py-2 rounded-lg hover:bg-opacity-80 active:opacity-40"
                    >
                      Delete
                    </button>
                    <button
                      onClick={closeDeleteModal}
                      className="bg-gray text-white px-4 py-2 rounded-lg active:bg-opacity-80"
                    >
                      Cancel
                    </button>
                  </div>
