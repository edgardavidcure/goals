            ...
            <div className="flex grow flex-col justify-between rounded-xl bg-extra-light-orange p-4">
              {latestGoals.map((goal, i) => (
                <Link
                  ...
                  className={clsx(
                    "flex flex-col items-center bg-white justify-between p-4 hover:bg-extra-light-orange",
                    {
                ...
                >
                  ...
                  <div
                    className={`truncate text-sm font-medium md:text-base w-full`}
                  >
              ...
              <div className="flex items-center pb-2 pt-6">
                ...
                <h3 className="ml-2 text-sm text-black mb-0 font-extralight italic">
                  Updated just now
                </h3>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <Link href={"/dashboard/create"}>
                <button
                  ...
                  className="w-fit bg-dark-blue rounded-lg py-4 px-2 text-white flex items-center gap-2 justify-evenly text-sm hover:bg-opacity-80"
                >
                  <PlusIcon className="w-4 text-white" /> Create Goal
                </button>
              </Link>
            </div>
          )}
