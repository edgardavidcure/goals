  ...
  return (
    <div className='flex flex-col relative gap-10 bg-extra-light-orange w-full py-10 px-6 rounded-xl'>
      <div>
        ...
        <p className='mt-0 text-black text-sm font-extralight italic'>Create your new goal</p>
      </div>
    <form action={dispatch} className="flex flex-col gap-5">
      ...
      <div className='flex gap-2 items-center justify-center'>
        ...
        <button type="submit" className='w-fit p-2 rounded-lg bg-dark-blue text-white hover:opacity-80'>Create Goal</button>
      </div>
      </form>
    </div>
  );
